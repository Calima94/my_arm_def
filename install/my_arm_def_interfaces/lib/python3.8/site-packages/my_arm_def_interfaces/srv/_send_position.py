...
class Metaclass_SendPosition_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('my_arm_def_interfaces')
        except ImportError:
            import logging
            import traceback
...
class Metaclass_SendPosition(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'my_arm_def_interfaces.srv.SendPosition')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from my_arm_def_interfaces.srv import _send_position
...
class SendPosition(metaclass=Metaclass_SendPosition):
    from my_arm_def_interfaces.srv._send_position import SendPosition_Request as Request
    from my_arm_def_interfaces.srv._send_position import SendPosition_Response as Response
