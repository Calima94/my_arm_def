...
bool my_arm_def_interfaces__msg__hardware_status__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("my_arm_def_interfaces.msg._hardware_status.HardwareStatus", full_classname_dest, 57) == 0);
  }
  my_arm_def_interfaces__msg__HardwareStatus * ros_message = _ros_message;
  {  // temperature
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * my_arm_def_interfaces__msg__hardware_status__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of HardwareStatus */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("my_arm_def_interfaces.msg._hardware_status");
  ...
  my_arm_def_interfaces__msg__HardwareStatus * ros_message = (my_arm_def_interfaces__msg__HardwareStatus *)raw_ros_message;
  {  // temperature
    PyObject * field = NULL;
